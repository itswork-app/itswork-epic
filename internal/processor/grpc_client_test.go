...
func TestBrainClient_AnalyzeToken_Success(t *testing.T) {
	...
	resp, err := client.AnalyzeToken(context.Background(), "mint123", "creator123", 100, true, 20.5, true, true, true, 0, 0, false, nil, "Safe", 0, "Low")
	assert.NoError(t, err)
...
func TestBrainClient_AnalyzeToken_NilClient(t *testing.T) {
	...
	_, err := bc.AnalyzeToken(context.Background(), "mint123", "creator123", 100, true, 20.5, true, true, true, 0, 0, false, nil, "Safe", 0, "Low")
	assert.Error(t, err)
}
...
func TestBrainClient_AnalyzeToken_Error(t *testing.T) {
	...
	_, err = client.AnalyzeToken(context.Background(), "mint123", "creator123", 100, true, 20.5, true, true, true, 0, 0, false, nil, "Safe", 0, "Low")
	assert.Error(t, err)
}
